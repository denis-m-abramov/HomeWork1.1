 ...
 */
var daysPassed: Float = Float(myAgeInTenYears) * Float(dayInYear)

/* можно явно не указывать тип Float так:
 ...
 */
print("Мой возраст  \(myAge) лет. Через 10 лет мне будет \(myAgeInTenYears) лет, с момента моего рождения пройдет \(Int(floor(daysPassed))) дней")
